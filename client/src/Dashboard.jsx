...
import TotalUniversity from './TotalUniversity.jsx';
...
<header className="sticky top-0 inset-x-0 flex flex-wrap sm:justify-start sm:flex-nowrap z-[48] w-full bg-white border-b text-sm py-2.5 sm:py-4 lg:ps-64 dark:bg-neutral-800 dark:border-neutral-700">
  <nav className="flex basis-full items-center w-full mx-auto px-4 sm:px-6" aria-label="Globsal">
            ...
            <div className="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-neutral-700">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-neutral-400">
                  Check The Process of Your Universities.
                </p>
              </div>
{/* Side of the table */}
              <div>
